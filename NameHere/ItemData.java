...
public class ItemData {
    ...
    */
    ...
    public static Item demonSword = new Item(10, 0, "Demon Sword", "Where did it come from?", 6, 5);
    ...
    public static Item slimeShield = new Item(0, 5, "Slime Shield", "Is it really a shield if it's permeable?", 6, 2);
    public static Item giantSkin = new Item(0, 5, "Giant Skin", "Wait but aren't giants just large humans?", 6, 2);
    ...
    public static Item soul = new Item(1, 20, "Soul", "I-it's just a soul why does it give you health?", 10, 9);
