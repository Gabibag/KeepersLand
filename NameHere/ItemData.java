...
public class ItemData {
    ...
    public static Item LavaVial = new Item(3, 0, "Lava Vial", "A vial of molten lava... what else would it be?", 15, 15);
    ...
    public static Item doransBlade = new Item(3, 2, "Doran's Blade", "A blade forged in the heart of Doran", 20, 55);
